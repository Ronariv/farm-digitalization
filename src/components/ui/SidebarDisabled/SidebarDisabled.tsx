...
const menuItems = (viewType: 'owner' | 'operator') => [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        />
        <path d="M7 14L11 10L15 14L21 8" stroke="#B3B3B3" strokeWidth="2" strokeMiterlimit="5.759" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M18 8H21V11" stroke="#B3B3B3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
...
export default SidebarDisabled;